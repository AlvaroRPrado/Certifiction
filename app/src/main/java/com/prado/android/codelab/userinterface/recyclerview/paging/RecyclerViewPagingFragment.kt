package com.prado.android.codelab.userinterface.recyclerview.paging
...
import com.prado.android.databinding.FragmentRecyclerViewPagingBinding
...
// https://developer.android.com/codelabs/android-paging?index=..%2F..%2Findex#4
    class RecyclerViewPagingFragment : Fragment(R.layout.fragment_recycler_view_paging) {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            // get the view model
            viewModel = ViewModelProvider(this, Injection.provideViewModelFactory())[SearchRepositoriesViewModel::class.java]
